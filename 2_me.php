    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
        <form class="navbar-form navbar-left" role="search">
          <a href="2_me.php#footer"><span class="glyphicon glyphicon-search  glyph" aria-hidden="true"></a>
        </form>        
      </ul>
    </div>
  </div>
   ...
   <div class="row">
    ...
    <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2me/1.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   Aplied Thermodynamics
				   <h5 class="price-text-color">&#8377;&nbsp;200&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2APPK</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=2APPK" >Buy Book</a></p>
                   <p class="btn-details">
	  ...
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2me/2.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   Hydraulics and Fluid
				   <h5 class="price-text-color">&#8377;&nbsp;300&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2HFPN</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=2HFPN" >Buy Book</a></p>
                   <p class="btn-details">
                   <span class="glyphicon glyphicon-flag"></span>&nbsp;<a href="#" data-toggle="modal" data-target="#myModal3"  data-toggle="tooltip" data-placement="top" title="sell BOOK" >Sell Book</a></p>
                   </div>
                   <div class="clearfix">
	  ...
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2me/3.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   Fluid Mechanics
	  ...
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2me/4.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   SOM
				   <h5 class="price-text-color">&#8377;&nbsp;240&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2SMSS</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=2SMSS" >Buy Book</a></p>
                   <p class="btn-details">
                   <span class="glyphicon glyphicon-flag"></span>&nbsp;<a href="#" data-toggle="modal" data-target="#myModal3"  data-toggle="tooltip" data-placement="top" title="sell BOOK" >Sell Book</a></p>
                   </div>
                   <div class="clearfix">
   ...
   <div class="row">
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2me/5.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                  Thermodynamics
				   <h5 class="price-text-color">&#8377;&nbsp;110&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2TDDS</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=2TDDS" >Buy Book</a></p>
                   <p class="btn-details">
                   <span class="glyphicon glyphicon-flag"></span>&nbsp;<a href="#" data-toggle="modal" data-target="#myModal3"  data-toggle="tooltip" data-placement="top" title="sell BOOK" >Sell Book</a></p>
                   </div>
                   <div class="clearfix">
	  ...
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2me/6.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   Applied Thermodynamics
				   <h5 class="price-text-color">&#8377;&nbsp;200&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2ATOS</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=2ATOS" >Buy Book</a></p>
                   <p class="btn-details">
                   <span class="glyphicon glyphicon-flag"></span>&nbsp;<a href="#" data-toggle="modal" data-target="#myModal3"  data-toggle="tooltip" data-placement="top" title="sell BOOK" >Sell Book</a></p>
                   </div>
                   <div class="clearfix">
	  ...
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2me/7.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   Manufacturing Science
				   <h5 class="price-text-color">&#8377;&nbsp;120&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2MSAG</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=2MSAG" >Buy Book</a></p>
                   <p class="btn-details">
                   <span class="glyphicon glyphicon-flag"></span>&nbsp;<a href="#" data-toggle="modal" data-target="#myModal3"  data-toggle="tooltip" data-placement="top" title="sell BOOK" >Sell Book</a></p>
                   </div>
                   <div class="clearfix">
	  ...
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2me/8.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   Theory of Machines
				   <h5 class="price-text-color">&#8377;&nbsp;240&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2TMSS</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=2TMSS" >Buy Book</a></p>
                   <p class="btn-details">
                   <span class="glyphicon glyphicon-flag"></span>&nbsp;<a href="#" data-toggle="modal" data-target="#myModal3"  data-toggle="tooltip" data-placement="top" title="sell BOOK" >Sell Book</a></p>
                   </div>
                   <div class="clearfix">
   ...
   <div class="row">
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2me/9.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   Material Science
				   <h5 class="price-text-color">&#8377;&nbsp;150&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2MSKM</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=2MSKM" >Buy Book</a></p>
                   <p class="btn-details">
                   <span class="glyphicon glyphicon-flag"></span>&nbsp;<a href="#" data-toggle="modal" data-target="#myModal3"  data-toggle="tooltip" data-placement="top" title="sell BOOK" >Sell Book</a></p>
                   </div>
                   <div class="clearfix">
	  ...
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2me/10.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   Mechanics of Solid
				   <h5 class="price-text-color">&#8377;&nbsp;180&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2SMIJ</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=2SMIJ" >Buy Book</a></p>
                   <p class="btn-details">
                   <span class="glyphicon glyphicon-flag"></span>&nbsp;<a href="#" data-toggle="modal" data-target="#myModal3"  data-toggle="tooltip" data-placement="top" title="sell BOOK" >Sell Book</a></p>
                   </div>
                   <div class="clearfix">
	  ...
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2me/11.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   Engineeering Mathmatics
	  ...
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2me/12.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   SOM
    ...
    <div class="modal-content">
     <div class="modal-footer">
       <img width="250" height="360" src="image/aaa.gif"   alt="REGISTER ON OLBE" align="left"> 
	      <form class="form-inline" role="form" method="post" action="2_me.php">
           <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
            <br>
             <div class="form-group">
