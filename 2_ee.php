    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
        <form class="navbar-form navbar-left" role="search">
          <a href="2_ee.php#footer"><span class="glyphicon glyphicon-search  glyph" aria-hidden="true"></a>
        </form>        
      </ul>
    </div>
  </div>
   ...
   <div class="row">
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" title="click to download PDF"> <img src="image/2ee/1.jpg"  alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   Engineering Measurement
				   <h5 class="price-text-color">&#8377;&nbsp;230&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2EIAK</h5>
	  ...
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2ee/2.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   Thermal Hydraulics
				   <h5 class="price-text-color">&#8377;&nbsp;120&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2THDS</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=1emhk" >Buy Book</a></p>
                   <p class="btn-details">
	  ...
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2ee/3.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   Analog and Digital
				   <h5 class="price-text-color">&#8377;&nbsp;100&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2ADPR</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=1emhk" >Buy Book</a></p>
                   <p class="btn-details">
	  ...
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2ee/4.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   Basic System
				   <h5 class="price-text-color">&#8377;&nbsp;200&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2BSUA</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=1emhk" >Buy Book</a></p>
                   <p class="btn-details">
   ...
   <div class="row">
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  ...
                  <div class="info">
                   Digital Design
				   <h5 class="price-text-color">&#8377;&nbsp;150&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2DDMM</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=1emhk" >Buy Book</a></p>
                   <p class="btn-details">
	  ...
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2ee/6.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   Signals and System
				   <h5 class="price-text-color">&#8377;&nbsp;300&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2SSVS</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=1emhk" >Buy Book</a></p>
                   <p class="btn-details">
	  ...
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2ee/7.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   Electrical Measurement
				   <h5 class="price-text-color">&#8377;&nbsp;100&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2EMAK</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=1emhk" >Buy Book</a></p>
                   <p class="btn-details">
	  ...
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2ee/8.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   Analysis of basic Sys
				   <h5 class="price-text-color">&#8377;&nbsp;60&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2ABSM</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=1emhk" >Buy Book</a></p>
                   <p class="btn-details">
   ...
   <div class="row">
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" title="click to download PDF"> <img src="image/2ee/10.jpg"  alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   Electrical Machinery
				   <h5 class="price-text-color">&#8377;&nbsp;150&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2EMPS</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=2EMPS" >Buy Book</a></p>
                   <p class="btn-details">
                   <span class="glyphicon glyphicon-flag"></span>&nbsp;<a href="#" data-toggle="modal" data-target="#myModal3"  data-toggle="tooltip" data-placement="top" title="sell BOOK" >Sell Book</a></p>
                   </div>
                   <div class="clearfix">
	  ...
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2ee/1.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   Microprocessor
				   <h5 class="price-text-color">&#8377;&nbsp;150&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2MPRS</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=2MPRS" >Buy Book</a></p>
                   <p class="btn-details">
                   <span class="glyphicon glyphicon-flag"></span>&nbsp;<a href="#" data-toggle="modal" data-target="#myModal3"  data-toggle="tooltip" data-placement="top" title="sell BOOK" >Sell Book</a></p>
                   </div>
                   <div class="clearfix">
	  ...
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2ee/12.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   Microprocessor
				   <h5 class="price-text-color">&#8377;&nbsp;100&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2MPRG</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=2MPRG" >Buy Book</a></p>
                   <p class="btn-details">
                   <span class="glyphicon glyphicon-flag"></span>&nbsp;<a href="#" data-toggle="modal" data-target="#myModal3"  data-toggle="tooltip" data-placement="top" title="sell BOOK" >Sell Book</a></p>
                   </div>
                   <div class="clearfix">
	  ...
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2ee/13.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   Electrical Terminology
				   <h5 class="price-text-color">&#8377;&nbsp;200&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2ETTH</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=2ETTH" >Buy Book</a></p>
                   <p class="btn-details">
                   <span class="glyphicon glyphicon-flag"></span>&nbsp;<a href="#" data-toggle="modal" data-target="#myModal3"  data-toggle="tooltip" data-placement="top" title="sell BOOK" >Sell Book</a></p>
                   </div>
                   <div class="clearfix">
   ...
   <div class="row">
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2ee/14.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   Electromagnatic Feild
				   <h5 class="price-text-color">&#8377;&nbsp;200&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2EFUA</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=2EFUA" >Buy Book</a></p>
                   <p class="btn-details">
                   <span class="glyphicon glyphicon-flag"></span>&nbsp;<a href="#" data-toggle="modal" data-target="#myModal3"  data-toggle="tooltip" data-placement="top" title="sell BOOK" >Sell Book</a></p>
                   </div>
                   <div class="clearfix">
	  ...
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2ee/15.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   Principal Electromagnatic
				   <h5 class="price-text-color">&#8377;&nbsp;250&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2PESK</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=2PESK" >Buy Book</a></p>
                   <p class="btn-details">
                   <span class="glyphicon glyphicon-flag"></span>&nbsp;<a href="#" data-toggle="modal" data-target="#myModal3"  data-toggle="tooltip" data-placement="top" title="sell BOOK" >Sell Book</a></p>
                   </div>
                   <div class="clearfix">
	  ...
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2ee/16.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   Circuit Theory
				   <h5 class="price-text-color">&#8377;&nbsp;150&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2CTAC</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=2CTAC" >Buy Book</a></p>
                   <p class="btn-details">
                   <span class="glyphicon glyphicon-flag"></span>&nbsp;<a href="#" data-toggle="modal" data-target="#myModal3"  data-toggle="tooltip" data-placement="top" title="sell BOOK" >Sell Book</a></p>
                   </div>
                   <div class="clearfix">
	  ...
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2ee/17.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   Engineering Material
				   <h5 class="price-text-color">&#8377;&nbsp;150&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2ESRK</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=2ESRK" >Buy Book</a></p>
                   <p class="btn-details">
                   <span class="glyphicon glyphicon-flag"></span>&nbsp;<a href="#" data-toggle="modal" data-target="#myModal3"  data-toggle="tooltip" data-placement="top" title="sell BOOK" >Sell Book</a></p>
                   </div>
                   <div class="clearfix">
   ...
   <div class="row">
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2ee/19.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   EEE Materials
				   <h5 class="price-text-color">&#8377;&nbsp;80&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2EEJB</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=2EEJB" >Buy Book</a></p>
                   <p class="btn-details">
                   <span class="glyphicon glyphicon-flag"></span>&nbsp;<a href="#" data-toggle="modal" data-target="#myModal3"  data-toggle="tooltip" data-placement="top" title="sell BOOK" >Sell Book</a></p>
                   </div>
                   <div class="clearfix">
    ...
    <div class="modal-content">
     <div class="modal-footer">
       <img width="250" height="360" src="image/aaa.gif"   alt="REGISTER ON OLBE" align="left"> 
	      <form class="form-inline" role="form" method="post" action="2_ee.php">
           <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
            <br>
             <div class="form-group">
