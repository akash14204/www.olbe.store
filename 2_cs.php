    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
        <form class="navbar-form navbar-left" role="search">
          <a href="2_cs.php#footer"><span class="glyphicon glyphicon-search  glyph" aria-hidden="true"></a>
        </form>        
      </ul>
    </div>
  </div>
   ...
   <div class="row">
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" title="click to download PDF"> <img src="image/2cs/1.jpg"  alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   Engineering Mathematics
				   <h5 class="price-text-color">&#8377;&nbsp;170&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2EMHK</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=2EMHK" >Buy Book</a></p>
                   <p class="btn-details">
	  ...
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2cs/2.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   Engineering Mathematics
				   <h5 class="price-text-color">&#8377;&nbsp;190&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2EMNP</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=2EMNP" >Buy Book</a></p>
                   <p class="btn-details">
                   <span class="glyphicon glyphicon-flag"></span>&nbsp;<a href="#" data-toggle="modal" data-target="#myModal3"  data-toggle="tooltip" data-placement="top" title="sell BOOK" >Sell Book</a></p>
                   </div>
                   <div class="clearfix">
	  ...
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2cs/3.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   Data Structure
				   <h5 class="price-text-color">&#8377;&nbsp;100&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2DSBL</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=2DSBL" >Buy Book</a></p>
                   <p class="btn-details">
                   <span class="glyphicon glyphicon-flag"></span>&nbsp;<a href="#" data-toggle="modal" data-target="#myModal3"  data-toggle="tooltip" data-placement="top" title="sell BOOK" >Sell Book</a></p>
                   </div>
                   <div class="clearfix">
	  ...
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2cs/4.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   OOS Java
				   <h5 class="price-text-color">&#8377;&nbsp;120&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2OSLA</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=2OSLA" >Buy Book</a></p>
                   <p class="btn-details">
                   <span class="glyphicon glyphicon-flag"></span>&nbsp;<a href="#" data-toggle="modal" data-target="#myModal3"  data-toggle="tooltip" data-placement="top" title="sell BOOK" >Sell Book</a></p>
                   </div>
                   <div class="clearfix">
   ...
   <div class="row">
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2cs/5.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   Data Structure 
				   <h5 class="price-text-color">&#8377;&nbsp;NA&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2DSSL</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=2DSSL" >Buy Book</a></p>
                   <p class="btn-details">
                   <span class="glyphicon glyphicon-flag"></span>&nbsp;<a href="#" data-toggle="modal" data-target="#myModal3"  data-toggle="tooltip" data-placement="top" title="sell BOOK" >Sell Book</a></p>
                   </div>
                   <div class="clearfix">
	  ...
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2cs/6.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   Automata
				   <h5 class="price-text-color">&#8377;&nbsp;100&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2AMAM</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=2AMAM" >Buy Book</a></p>
                   <p class="btn-details">
                   <span class="glyphicon glyphicon-flag"></span>&nbsp;<a href="#" data-toggle="modal" data-target="#myModal3"  data-toggle="tooltip" data-placement="top" title="sell BOOK" >Sell Book</a></p>
                   </div>
                   <div class="clearfix">
	  ...
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2cs/7.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   Digital Electronics
				   <h5 class="price-text-color">&#8377;&nbsp;110&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2DLPR</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=2DLPR" >Buy Book</a></p>
                   <p class="btn-details">
                   <span class="glyphicon glyphicon-flag"></span>&nbsp;<a href="#" data-toggle="modal" data-target="#myModal3"  data-toggle="tooltip" data-placement="top" title="sell BOOK" >Sell Book</a></p>
                   </div>
                   <div class="clearfix">
	  ...
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2cs/8.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   Discrete Mathematics
				   <h5 class="price-text-color">&#8377;&nbsp;200&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2DMSC</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=2DMSC" >Buy Book</a></p>
                   <p class="btn-details">
                   <span class="glyphicon glyphicon-flag"></span>&nbsp;<a href="#" data-toggle="modal" data-target="#myModal3"  data-toggle="tooltip" data-placement="top" title="sell BOOK" >Sell Book</a></p>
                   </div>
                   <div class="clearfix">
   ...
   <div class="row">
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2cs/9.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   Computer Organisation
				   <h5 class="price-text-color">&#8377;&nbsp;100&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2COPR</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=2COPR" >Buy Book</a></p>
                   <p class="btn-details">
                   <span class="glyphicon glyphicon-flag"></span>&nbsp;<a href="#" data-toggle="modal" data-target="#myModal3"  data-toggle="tooltip" data-placement="top" title="sell BOOK" >Sell Book</a></p>
                   </div>
                   <div class="clearfix">
	  ...
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2cs/10.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   Computer Architechture
				   <h5 class="price-text-color">&#8377;&nbsp;NA&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2COMM</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=2COMM" >Buy Book</a></p>
                   <p class="btn-details">
                   <span class="glyphicon glyphicon-flag"></span>&nbsp;<a href="#" data-toggle="modal" data-target="#myModal3"  data-toggle="tooltip" data-placement="top" title="sell BOOK" >Sell Book</a></p>
                   </div>
                   <div class="clearfix">
	  ...
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2cs/11.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   Data Structure
				   <h5 class="price-text-color">&#8377;&nbsp;170&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2DSTB</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=2DSTB" >Buy Book</a></p>
                   <p class="btn-details">
                   <span class="glyphicon glyphicon-flag"></span>&nbsp;<a href="#" data-toggle="modal" data-target="#myModal3"  data-toggle="tooltip" data-placement="top" title="sell BOOK" >Sell Book</a></p>
                   </div>
                   <div class="clearfix">
	  ...
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2cs/12.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   Data Communication
				   <h5 class="price-text-color">&#8377;&nbsp;270&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2DCFZ</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=2DCFZ" >Buy Book</a></p>
                   <p class="btn-details">
                   <span class="glyphicon glyphicon-flag"></span>&nbsp;<a href="#" data-toggle="modal" data-target="#myModal3"  data-toggle="tooltip" data-placement="top" title="sell BOOK" >Sell Book</a></p>
                   </div>
                   <div class="clearfix">
   ...
   <div class="row">
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2cs/13.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   DBMS
				   <h5 class="price-text-color">&#8377;&nbsp;230&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2DBBD</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=2DBBD" >Buy Book</a></p>
                   <p class="btn-details">
                   <span class="glyphicon glyphicon-flag"></span>&nbsp;<a href="#" data-toggle="modal" data-target="#myModal3"  data-toggle="tooltip" data-placement="top" title="sell BOOK" >Sell Book</a></p>
                   </div>
                   <div class="clearfix">
	  ...
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2cs/14.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   DBMS
				   <h5 class="price-text-color">&#8377;&nbsp;NA&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2DBNV</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=2DBNV" >Buy Book</a></p>
                   <p class="btn-details">
                   <span class="glyphicon glyphicon-flag"></span>&nbsp;<a href="#" data-toggle="modal" data-target="#myModal3"  data-toggle="tooltip" data-placement="top" title="sell BOOK" >Sell Book</a></p>
                   </div>
                   <div class="clearfix">
	  ...
	  <div class="col-lg-3">
		 <div class="block">
             <div class="col-item">
                  <div class="photo">
                     <a href="index.html" class="hovertext" title="click to download PDF"> <img src="image/2cs/15.jpg" class="img-responsive" alt="download PDF" /></a>
                  </div>
                  <div class="info">
                   OOS
				   <h5 class="price-text-color">&#8377;&nbsp;220&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Code:&nbsp;2OSRB</h5>
                   <div class="separator clear-left">
                   <p class="btn-add">
                   <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;<a href="seller_page.php?book_id=2OSRB" >Buy Book</a></p>
                   <p class="btn-details">
                   <span class="glyphicon glyphicon-flag"></span>&nbsp;<a href="#" data-toggle="modal" data-target="#myModal3"  data-toggle="tooltip" data-placement="top" title="sell BOOK" >Sell Book</a></p>
                   </div>
                   <div class="clearfix">
    ...
    <div class="modal-content">
     <div class="modal-footer">
       <img width="250" height="360" src="image/aaa.gif"   alt="REGISTER ON OLBE" align="left"> 
	      <form class="form-inline" role="form" method="post" action="2_cs.php">
           <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
            <br>
             <div class="form-group">
